...
public class RoslynPlugin extends SonarPlugin {          
  ...
  public List getExtensions() {
    ...
    builder.add(
      RulesDefinitionCSharpRoslyn.class,
      RulesDefinitionVbNetRoslyn.class,
      SonarWayProfileCSharp.class,
      SonarWayProfileVbNet.class,
      RoslynRunnerExtractor.class,
      RoslynSensor.class);
    
    builder.addAll(generalProperties());
