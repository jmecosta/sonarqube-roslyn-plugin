...
public class SonarWayProfileCSharp implements BuiltInQualityProfilesDefinition {


  @Override
  public void define(Context context) {
    context.createBuiltInQualityProfile(RoslynPlugin.ROSLYN_PROFILE_NAME, RoslynPlugin.CS_LANGUAGE_KEY);
  }
}
